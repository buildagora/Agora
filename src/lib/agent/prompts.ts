...
- neededBy: string (date or timeframe mentioned)
...
/**
 * Legacy function for stateMachine compatibility
 * @deprecated Use Phase 3 agent turn endpoint instead
 */
export function getAssistantPrompt(expectedField: any, _draft: any): string {
  // Minimal implementation for backward compatibility
  switch (expectedField) {
    case "lineItems":
      return "What materials do you need? Include quantities and units (e.g., 10 bundles shingles, 1 box nails).";
    case "fulfillment":
      return "Do you need delivery or pickup?";
    case "neededBy":
      return "When do you need this by?";
    case "jobNamePo":
      return "Do you have a job name or PO #? (optional)";
    default:
