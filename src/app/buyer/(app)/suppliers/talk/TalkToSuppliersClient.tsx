...
export default function TalkToSuppliersClient({
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="w-full md:w-64 border-r border-zinc-200 overflow-y-auto bg-white flex-shrink-0">
          ...
          {conversations.length === 0 ? (
            ...
            conversations.map((conv) => (
              <Link
                ...
                className="block"
              >
                <Card className="mb-2.5 cursor-pointer hover:bg-zinc-50 transition-colors">
