          ...
          <Card className="mb-6">
            <CardContent className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Category Filter */}
                <div>
                  <label htmlFor="category-filter" className="block text-sm font-medium text-zinc-700 mb-2">
                    Category
                  </label>
                  <select
                    id="category-filter"
                    ...
                    className="w-full px-3 py-2 border border-zinc-300 rounded-lg bg-white text-black focus:outline-none focus:ring-2 focus:ring-slate-600"
                  >
                ...
                {/* Fulfillment Type Filter */}
                <div>
                  <label htmlFor="fulfillment-filter" className="block text-sm font-medium text-zinc-700 mb-2">
                    Fulfillment Type
                  </label>
                  <select
          ...
          <div>
            ...
            {filteredBroadcastRfqs.length === 0 ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                return (
                <Card key={rfqId} className="hover:bg-zinc-50 transition-colors">
                  <CardContent className="p-4">
