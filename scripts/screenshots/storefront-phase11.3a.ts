/**
 * Capture Phase 11.3A storefront screenshots.
 * Run: npx tsx scripts/screenshots/storefront-phase11.3a.ts
 */
...
const OUT_DIR = join(process.cwd(), "scripts/output/screenshots/phase11.3a");
