...
/**
 * Get question text for a field (replacement for removed getAssistantPrompt)
 */
function getAssistantPrompt(field: ExpectedField, draft: any): string {
  if (!field) return "I'm here to help. What would you like to know?";
  ...
  switch (field) {
    ...
    case "roofMaterialType":
      return "What type of roofing material? (Shingle or Metal)";
    case "roofSizeSquares":
      return "How many squares?";
    case "roofAccessoriesNeeded":
      return "Do you need accessories? (Yes or No)";
    case "lineItems":
      return "What materials, quantities, and units do you need?";
    case "priority":
      return "What's your priority? (Fastest, Best price, Preferred supplier, or Not sure)";
    case "jobNamePo":
      return "What should I label this as? (e.g., Beirne Ave — PO 10492)";
    default:
